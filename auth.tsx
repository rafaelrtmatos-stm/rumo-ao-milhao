          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  className="w-full h-14 pl-12 pr-4 bg-slate-50 border-none rounded-2xl text-sm font-bold placeholder:text-slate-300 focus:ring-2 focus:ring-[#2d5016]/20 transition-all outline-none"
                  value={email}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-16 bg-[#2d5016] text-white rounded-2xl text-xs uppercase tracking-[0.2em] font-black shadow-xl shadow-[#2d5016]/20 hover:bg-[#1a300d] transition-all transform hover:-translate-y-1 active:scale-95 disabled:opacity-60"
            >
