...
async function criarPdfPorNavegador(_html: string): Promise<Buffer> {
  // Puppeteer is stripped in container environment; client handles PDF export via jsPDF/html2canvas
  throw new Error("Geração de PDF por Chromium não disponível no container. Use o exportador nativo pelo navegador.");
}
